...
<body class="body">
	<h1 class="text-center text-primary-emphasis textColor mt-4">Edit Any Information </h1>
<form:form action="/community/update/${communityToEdit.id}" method="POST" modelAttribute="communityToEdit" class="createForm">
