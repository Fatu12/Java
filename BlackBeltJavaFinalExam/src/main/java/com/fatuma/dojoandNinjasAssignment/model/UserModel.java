...
public class UserModel {
	...
	//=========basic class object Attratutes========
	    ...
	    private List<GameModel> myGame;
	    
	    @OneToMany(mappedBy="userMechanic", fetch=FetchType.LAZY)
	    private List<GameMechanicModel> creatorMechanic;
	    
	    
	    
	    public List<GameMechanicModel> getCreatorMechanic() {
			return creatorMechanic;
		}

		public void setCreatorMechanic(List<GameMechanicModel> creatorMechanic) {
			this.creatorMechanic = creatorMechanic;
		}

		public List<GameModel> getMyGame() {
			return myGame;
		}

		public void setMyGame(List<GameModel> myGame) {
			this.myGame = myGame;
		}
