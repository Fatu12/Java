	...
	//=========basic class object Attratutes========
	  ...
	  //======================= TABLE RELATIONSHIP =======================
		 @OneToMany(mappedBy="creator", fetch = FetchType.LAZY)
		   private List<ProjectsModels> myProjects;
...
//		    )
//		 
//		    private List<ProjectsModels> millonDollerIdeas;
//	    
	    // ===================CONSTURCTURE===================== 
		public UserModel() {
		...
		public List<ProjectsModels> getMyProjects() {
			return myProjects;
		}

		public void setMyProjects(List<ProjectsModels> myProjects) {
