...
<body>
	<h1 class="text-center text-primary-emphasis "> Update a Project </h1>

		<form:form action="/projects/update/${updatedProject.id}" method="POST" modelAttribute="updatedProject">
