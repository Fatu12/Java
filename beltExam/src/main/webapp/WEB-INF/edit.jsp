...
<body>
	<h1 class="text-center text-primary-emphasis ">Edit Project ${uptateProject.title}</h1>

		<form:form action="/project/update/${updatedProject.id}" method="POST" modelAttribute="updatedProject">
