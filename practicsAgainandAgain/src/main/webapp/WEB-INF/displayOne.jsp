 ...
 <hr>
  ...
  <c:if test = "${showBook.creatore.id eq userID}">
	...
	<a  href="/users/${showBook.id}/edit"> edit </a>
       ...
       <a class="offset-1" href="/delete/users/${showBook.id}"> delete </a>
       </div>
