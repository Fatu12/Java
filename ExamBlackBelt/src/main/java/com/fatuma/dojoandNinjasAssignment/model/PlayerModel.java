...
public class PlayerModel {
    ...
    @Size(min=3, max=255, message="player name must be 3 more than  characters")
    private String  playerName;  
    
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name ="team_id")
    private TeamModel teamPlayer;
    
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name="user_id")
    private UserModel userPlayer;
	public PlayerModel() {
	...
	public void setTeamPlayer(TeamModel teamPlayer) {
		this.teamPlayer = teamPlayer;
	}

	public UserModel getUserPlayer() {
		return userPlayer;
	}

	public void setUserPlayer(UserModel userPlayer) {
