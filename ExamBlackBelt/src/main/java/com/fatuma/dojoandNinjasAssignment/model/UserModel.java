...
public class UserModel {
	...
	//=========basic class object Attratutes========
	    ...
	    private List<TeamModel> myTeam;
	    
	    @OneToMany(mappedBy="userPlayer", fetch=FetchType.LAZY)
	    private List<PlayerModel> creatorPlayer;
		 
	 
	    public List<TeamModel> getMyTeam() {
			return myTeam;
		}

		public void setMyTeam(List<TeamModel> myTeam) {
			this.myTeam = myTeam;
		}

		public List<PlayerModel> getCreatorPlayer() {
			return creatorPlayer;
		}

		public void setCreatorPlayer(List<PlayerModel> creatorPlayer) {
