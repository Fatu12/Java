...
public class UserModel {
	...
	//=========basic class object Attratutes========
	    ...
	    private List<ProjectModel> millionDollaerIdeas;
		...
		public List<ProjectModel> getMillionDollaerIdeas() {
			return millionDollaerIdeas;
		}


		public void setMillionDollaerIdeas(List<ProjectModel> millionDollaerIdeas) {
			this.millionDollaerIdeas = millionDollaerIdeas;
		}
