...
public class UserModel {
	...
	// ============== basic class object Attratutes  =============
	    ...
	    @Size(min=3, max=255, message="First Name must be between 3 and 30 characters")
	    private String lastName;
	    
	    
	    @NotBlank(message="last name is required!")
	    @Size(min=3, max=255, message="Last Name must be between 3 and 30 characters")
	    ...
	    @Size(min=8, max=255, message="Confirm Password must be between 8 and 128 characters")
		...
		//======================= TABLE RELATIONSHIP ==================================
			    ...
			    // for the "mappedBy" it need to plaged the attribute name of the other table and
