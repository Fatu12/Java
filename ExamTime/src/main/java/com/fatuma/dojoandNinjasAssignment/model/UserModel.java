...
public class UserModel {
	...
	//=========basic class object Attratutes========
	    ...
	    private List<HouseHunterModel> listHouses;
		
		@OneToMany(mappedBy="userNote", fetch=FetchType.LAZY)
	    private List<NoteModel> createrNote;
		//================== GETTER AND SETTER ================
		...
		public List<HouseHunterModel> getListHouses() {
			return listHouses;
		}

		public void setListHouses(List<HouseHunterModel> listHouses) {
			this.listHouses = listHouses;
		}

		public List<NoteModel> getCreaterNote() {
			return createrNote;
		}

		public void setCreaterNote(List<NoteModel> createrNote) {
			this.createrNote = createrNote;
		}
