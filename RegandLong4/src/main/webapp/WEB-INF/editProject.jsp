...
<body>
	<h1 class="text-center text-primary-emphasis ">All Books </h1>


<form:form action="/projects/update/${updateProject.id}" method="POST" modelAttribute="updateProject">
<input type="hidden" name="user" value="${user.id}" />
 <div class= "offset-1 ps-5">
  ...
  <div class="form-group mt-2 ">
   ...
   <p> <form:label path="comment">:</form:label></p>
  ...
  <button type="submit" class="btn btn-primary">Submit</button>
       ...
       <a href="/projects/delete/${updateProject.id}">Back to Dashboard</a>
